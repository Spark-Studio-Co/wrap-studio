...
import { Form } from '@/features/contacts/ui/form/form';
...
export const ServiceFormPopup = () => {
    const { close, isOpen, selectedService } = usePopupStore('servicePopup');
            ...
            {isOpen && (
                ...
                >
                    ...
                    >
                        ...
                        <Form isFull selectedService={selectedService} />
                    </motion.div>
                </motion.div>
            )}
        </AnimatePresence>
